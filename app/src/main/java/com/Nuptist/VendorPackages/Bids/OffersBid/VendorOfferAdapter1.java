...
public class VendorOfferAdapter1 extends RecyclerView.Adapter<VendorOfferAdapter1.ViewHolder>{
    Context context ;
    ...
    public VendorOfferAdapter1(Context context, BidInterface bidInterface, List<OfferFinalModel> model) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(position == 0 ){
            ...
            holder.binding.addOnceRecycler.setAdapter(new VendorOfferAdpater2(context,model.get(holder.getAbsoluteAdapterPosition()).getProductOfferDetailsIds(),model.get(holder.getAbsoluteAdapterPosition()).getServiceOfferDetailsIds(), bidInterface));
