...
public class MyBookingOffersAdapter extends RecyclerView.Adapter<MyBookingOffersAdapter.ViewHolder>{

    Context context ;
    List<MyBookingDetailsModel.MyBookingdata.ProductOfferIdList> model ;
    List<MyBookingDetailsModel.MyBookingdata.ServiceOfferIdList> model2 ;
    String url = IMAGE_URL ;

    public MyBookingOffersAdapter(Context context, List<MyBookingDetailsModel.MyBookingdata.ProductOfferIdList> model, List<MyBookingDetailsModel.MyBookingdata.ServiceOfferIdList> model2) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        try {
            ...
            if( position < model.size()){
                ...
                MyBookingDetailsModel.MyBookingdata.ProductOfferIdList data = model.get(position);
               ...
               // holder.price.setText("Rs. "+data.getRecommendedPrice());
                ...
                MyBookingDetailsModel.MyBookingdata.ServiceOfferIdList data = model2.get(pos);
